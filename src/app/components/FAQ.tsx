...
export default function FAQ() {
    const questions = [
        ...
        { question: 'Quais modos de jogo existem?', answer: 'Em um primeiro momento é possível jogar apenas D&D 5e sem precisar adquirir um livro, porém já está planejado desenvolvermos um modo mais geral, que se encaixa com qualquer sistema de RPG.' },
