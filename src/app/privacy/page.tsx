...
const privacySections = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'Tambem podemos tratar dados tecnicos e operacionais, como identificadores de sessao, registros basicos de acesso, preferencias locais e informacoes necessarias para autenticacao, seguranca e funcionamento da conta.',
        ],
        bullets: [
            ...
            'dados tecnicos indispensaveis para estabilidade, seguranca e prevencao de abuso.',
        ],
    },
    {
        title: '3. Como usamos os dados',
        paragraphs: [
            'Os dados tratados pelo TableRise sao utilizados para permitir o acesso a conta, disponibilizar funcionalidades da plataforma, manter campanhas e personagens, responder solicitacoes de suporte e proteger a integridade do servico.',
            'Tambem podemos utilizar informacoes para diagnostico tecnico, melhoria de experiencia, correcao de erros, prevencao de fraude e cumprimento de obrigacoes legais.',
        ],
    },
    {
        title: '4. Compartilhamento de dados',
        paragraphs: [
            'O TableRise nao comercializa dados pessoais. O compartilhamento pode ocorrer apenas quando necessario para operacao tecnica da plataforma, cumprimento de obrigacoes legais, investigacao de incidentes de seguranca ou protecao de direitos do TableRise e de terceiros.',
            'Quando houver integracoes, provedores de infraestrutura ou ferramentas de autenticacao, o tratamento de dados sera limitado ao necessario para prestar o servico correspondente.',
        ],
    },
    {
        title: '5. Armazenamento e seguranca',
        paragraphs: [
            'Adotamos medidas razoaveis para proteger os dados tratados contra acesso nao autorizado, alteracao indevida, perda acidental ou uso abusivo.',
    ...
    {
        title: '6. Base legal e retencao',
        paragraphs: [
            'Os dados podem ser tratados com fundamento em execucao do servico solicitado por voce, cumprimento de obrigacoes legais, exercicio regular de direitos e interesses legitimos relacionados a seguranca, estabilidade e evolucao da plataforma.',
            'As informacoes sao mantidas pelo tempo necessario para cumprir essas finalidades, respeitar exigencias legais, resolver disputas e preservar a continuidade operacional do TableRise.',
        ],
    },
    {
        title: '7. Direitos do titular',
        paragraphs: [
            'Conforme a legislacao aplicavel, voce pode solicitar confirmacao de tratamento, acesso, correcao, atualizacao, eliminacao quando cabivel e esclarecimentos sobre o uso de seus dados.',
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'Alguns desses recursos sao estritamente necessarios para o funcionamento do produto e podem permanecer ativos enquanto voce utiliza a plataforma.',
        ],
    },
    {
            ...
            <section className="terms-inside-container">
                <div className="terms-hero">
                    ...
                    <p className="font-S-regular terms-lead">
                        Ultima atualizacao: 9 de junho de 2026. Este texto serve como
