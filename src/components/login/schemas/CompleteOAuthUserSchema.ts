...
const profileCompletionFields = {
    firstName: z.string().min(2, { message: 'Nome deve ter no mí­nimo 2 caracteres*' }),
    lastName: z
        .string()
        .min(2, { message: 'Sobrenome deve ter no mí­nimo 2 caracteres*' }),
...
const completeOAuthUserSchema = z.object({
    nickname: z
        .string()
        .min(3, { message: 'Nickname deve ter no mí­nimo 3 caracteres*' })
