export const questions = [
    {
        question: 'O que é TableRise?',
        answer: 'É uma plataforma VTT (Virtual Table Top) para jogar RPG online com amigos.',
    },
    {
        question: 'TableRise é pago?',
        answer: 'Não, todas nossas funcionalidades são gratuitas.',
    },
    {
