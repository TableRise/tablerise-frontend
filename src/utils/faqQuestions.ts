export const questions = [
    ...
    { question: 'TableRise é pago?', answer: 'Não, todas nossas funcionalidades são gratuitas.' },
    { question: 'Quais modos de jogo existem?', answer: 'Em um primeiro momento é possível jogar apenas D&D, sem precisar adquirir um livro, porém já está planejado desenvolvermos um modo mais geral, que se encaixa com qualquer sistema de RPG.' },
